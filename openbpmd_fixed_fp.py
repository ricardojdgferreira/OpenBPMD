...
def main(args):
    ...
    for idx in range(0, args.nreps):
        ...
        if args.score == 'fingerprint':
            ContactScoreArr = get_fp_score(cent_eq_pdb, trj_name, args.lig_resname)
        else:
...
def equilibrate(min_pdb, parm, out_dir, eq_file_name):
    ...
    # Add the restraints on the positions
    # of specified atoms
